...
The Exchange Rates API Client is a REST client for [Exchange Rates API](https://exchangeratesapi.io/). According to [Europa Central Bank](https://www.ecb.europa.eu/stats/policy_and_exchange_rates/euro_reference_exchange_rates/html/index.en.html), Rate values are updated around 16:00 CET on every work day, so a [cache](#cache) model was built to improve response time. Also, inputs are validated following [OWASP](https://owasp.org/www-project-proactive-controls/v3/en/c5-validate-inputs) recommendations.
...
```bash
?query={
    transfer(domain:$SMARTMEI_DOMAIN, plan:$SMARTMEI_PLAN){    
        description,
        rates_date,
        BRL,
        USD,
...
|---------|-----------|------------|------------------------------------------------------|
|  domain |  `string` |     yes    |  `http://smartmei.com.br`, `https://smartmei.com.br` |
|  plan   |  `string` |    yes     | `Básico`, `Profissional`                             |
...
### Logs
Logs are pretty descriptive. They come in three levels: `info`, `warn` and `error`. Here is one example
of log output generated by a request:

```bash
fee-crawler    | {"level":"info","msg":"processing request with domain: https://www.smartmei.com.br plan: Básico","time":"2020-06-08T23:43:41Z"}
fee-crawler    | {"level":"info","msg":"crawling for plan: Básico on: https://www.smartmei.com.br","time":"2020-06-08T23:43:41Z"}
fee-crawler    | {"level":"info","msg":"retrieved fee string: \n                    R$ 7,00*\n*Limitado a contas PF do dono da MEI                ","time":"2020-06-08T23:43:41Z"}
fee-crawler    | {"level":"info","msg":"sanitized amount: 7,00","time":"2020-06-08T23:43:41Z"}
fee-crawler    | {"level":"info","msg":"normalized amount: 7.00","time":"2020-06-08T23:43:41Z"}
fee-crawler    | {"level":"info","msg":"sanitized description: *Limitado a contas PF do dono da MEI","time":"2020-06-08T23:43:41Z"}
fee-crawler    | {"level":"info","msg":"querying cache for rates","time":"2020-06-08T23:43:41Z"}
fee-crawler    | {"level":"error","msg":"redis: nil","time":"2020-06-08T23:43:41Z"}
fee-crawler    | {"level":"warning","msg":"could not find cache, will now make an external request","time":"2020-06-08T23:43:41Z"}
fee-crawler    | {"level":"info","msg":"retrieved latest rates from api","time":"2020-06-08T23:43:41Z"}
fee-crawler    | {"level":"info","msg":"parsed rates payload","time":"2020-06-08T23:43:41Z"}
fee-crawler    | {"level":"info","msg":"setting cache for rates","time":"2020-06-08T23:43:41Z"}
fee-crawler    | {"level":"info","msg":"retrieved rates: {Rates:{EUR:0.1795267674 USD:0.2025959571} Base:BRL Date:2020-06-08}","time":"2020-06-08T23:43:41Z"}
```
